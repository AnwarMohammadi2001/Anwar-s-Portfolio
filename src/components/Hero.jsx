    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p
            className={`${styles.heroSubText} mt-2 text-white glitch`}
            data-text="I craft seamless and interactive web experiences"
          >
            I craft seamless and interactive <br className="sm:block hidden" />
            web experiences
          </p>
        </div>
      </div>
      <div className="flex md:justify-end justify-center absolute inset-0 h-full w-full bottom-0 mt-56 md:mt-40">
