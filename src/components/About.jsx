...
const About = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 h-[500px]  items-center px-8  gap-10 overflow-hidden">
        {/* Text Section */}
        <motion.div
        ...
        >
          <p className="text-justify">
            ...
            modern, responsive, and scalable web applications. Proficient in
            Sass, Bootstrap, and Tailwind CSS, I craft intuitive user interfaces
            that enhance user experience. With strong skills in jQuery,
            TypeScript, React, and Redux Toolkit, I develop high-performance
            applications with clean, maintainable code. Staying updated with the
            latest industry trends, I continuously refine my skills to deliver
            top-notch solutions. Let's collaborate to bring your ideas to life!
          </p>
        </motion.div>
